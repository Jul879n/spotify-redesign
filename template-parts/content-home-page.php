...
<div id="post-<?php the_ID(); ?>" <?php post_class('user-select-none'); ?>>
	...
	<div id="fondo" class="container-fluid ">
		<div class="row grid-stack">
			<div id="card-menu" class="grid-stack-item col-12 col-sm-3 gs-4" gs-w="3">
				<div id="menu" class="grid-stack-item-content card border-0 tema h-100">
			...
			<div id="registrate" class="grid-stack-item placeholder-glow col-12 col-sm-9" gs-w="9">
				<div class="grid-stack-item-content card tema border-0">
					<div class="card-body placeholder d-flex align-items-center justify-content-between h-100">
			...
			<div id="izquierda" class="grid-stack-item placeholder-glow col-12 col-sm-4" gs-w="4" gs-h="5">
				<div id="reproductor" class="grid-stack-item-content card border-0 tema bg-secondary text-tema h-100">
			...
			<div id="principal" class="grid-stack-item placeholder-glow col-12 col-sm-8" gs-w="8" gs-h="5">
				<div id="contenido" class="grid-stack-item-content card border-0 tema bg-secondary text-tema h-100">
			...
			<div id="artista" class="grid-stack-item placeholder-glow col-12 col-sm-6" gs-w="6" gs-h="4">
				<div class="grid-stack-item-content card border-0 tema bg-secondary h-100">
