...
function spotify_template_setup() {
	/*
		...
		* to change 'spotify-template' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'spotify-template', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'spotify-template' ),
		)
	);
...
function spotify_template_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'spotify-template' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'spotify-template' ),
...
function spotify_template_scripts() {
	wp_enqueue_style( 'spotify-template-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'spotify-template-style', 'rtl', 'replace' );

	wp_enqueue_script( 'spotify-template-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
